...
<div class="content">
	...
	<div class="attention"><div class="emphasis">Your Photos, <br />Your Cloud!</div></div>
	...
	<div class="details section">
		<div class="row">
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Photo sharing</b> - share by link, shared folder, or email.</li>
					<li><b>Map viewer</b> - view geolocated photos on a map.</li>
			...
			<div class="col-sm-6">
				...
				<ul>
					<li>Easily <b>share</b> photos with friends, family, or colleagues. </li>
					<li><b>Revisit</b> your memories and <b>explore</b> your photos. </li>
