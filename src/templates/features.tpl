	...
	<div class="section">
		<div class="row">
			<div class="col-sm-6">
				...
				<p><%= application.name %> allows you to control access to your shared photos. You can share files or folders as read-only or read-write.  When sharing items by hyperlink, you can also set a access limits, expiration time, date, and password. </p>
			</div>
			<div class="col-sm-6">
				<div class="figure">
